(function($) {
    ...
    function render_conference(data, div){
        div.attr("class", "table table-striped table-bordered table-sm")
        var thead = $("<thead>")
            .appendTo(div)
        var tr = $("<tr>")
            .appendTo(thead)
        var names = ["Name", "Date", "Location", "Submission", "Notification"]
    ...
    function do_render(data){
        ...
        render_conference(data.conference, $("#conference"));
        
    }

    $(document).ready(function() {
        
        $.getJSON('data/conf.json', function(data) {
            do_render(data);
        });
    });
